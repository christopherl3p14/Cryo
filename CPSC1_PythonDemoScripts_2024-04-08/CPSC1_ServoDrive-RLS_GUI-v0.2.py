...
window.title(f'CPSC1 ServoDrive for 3 positioners with RLS feedback ({verNumber})') 
...
lblList[12] = tk.Label(text="Setpoint [m]: ",master=frm2) 
...
inpList[0][0] = tk.OptionMenu(frm2, parList[0][0], "CBS5-RLS", "CBS10-RLS", "CS021-RLS.X", "CS021-RLS.Y", "CS021-RLS.Z", "CLD1-RLS")
inpList[0][1] = tk.Spinbox(frm2, from_= 1, to = 600, textvariable=parList[0][1], width=5)
inpList[0][2] = tk.OptionMenu(frm2, parList[0][2], "CBS5-RLS", "CBS10-RLS", "CS021-RLS.X", "CS021-RLS.Y", "CS021-RLS.Z", "CLD1-RLS")
inpList[0][3] = tk.Spinbox(frm2, from_= 1, to = 600, textvariable=parList[0][3], width=5)
inpList[0][4] = tk.OptionMenu(frm2, parList[0][4], "CBS5-RLS", "CBS10-RLS", "CS021-RLS.X", "CS021-RLS.Y", "CS021-RLS.Z", "CLD1-RLS")
...
txtResp.insert('end', ('==> Note: Before using ServoDrive make sure the connected RSM module has been calibrated for the connected -RLS sensor(s). See Software User Manual for more information.\n'))
